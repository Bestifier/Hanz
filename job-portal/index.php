...
<div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>Best <strong>JOBS</strong> In One Place</h1>
            <p>Search, your dream Job</p>
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              ...
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">FCFA<?php echo $row['maximumsalary']; ?>/Month</span></h4>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/mark.jpg" alt="Browse Jobs">
              <div class="caption">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023-2024 <a href="learningfromscratch.online">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
